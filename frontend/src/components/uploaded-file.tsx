  ...
  <div className="group relative inline-block text-xs text-gray-900 mb-3 mx-[10px] md:mx-0">
    <span className="flex items-stretch justify-center">
      <span className="rounded-l-md bg-gray-500 px-2 py-2 text-white transition-colors dark:bg-gray-500">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" stroke-width="2" class="h-4 w-4 h-5 w-5">
    ...
    <button onClick={onDelete} className="absolute right-1 top-1 -translate-y-1/2 translate-x-1/2 rounded-full border border-white bg-gray-500 p-0.5 text-white transition-colors hover:bg-black hover:opacity-100 group-hover:opacity-100 md:opacity-0">
